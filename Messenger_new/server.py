...
import select
import time
from Messenger_new.common.variables import DEFAULT_PORT, MAX_CONNECTIONS, ACTION, TIME, USER, \
    ACCOUNT_NAME, SENDER, PRESENCE, RESPONSE, ERROR, MESSAGE, MESSAGE_TEXT, RESPONSE_400, RESPONSE_200, DESTINATION, \
    EXIT
from Messenger_new.common.utils import get_message, send_message
